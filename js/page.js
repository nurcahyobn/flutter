...
if(r.d){if(r.a==="List")return p+" = map['"+H.c(a)+"'].cast<"+H.c(r.b)+">();"
return p+" = map['"+H.c(a)+"'];"}else{u=r.a
t=u==="List"
if(t&&r.b==="DateTime")return p+" = map['"+H.c(a)+"'].map((v) => DateTime.tryParse(v));"
...
u.a=t
u.a=t+".fromMap(Map<String, dynamic> map) {\n"
this.c.gai().a2(0,new M.jd(this,u))
t=u.a+="\t}"
return t.charCodeAt(0)==0?t:t},
gnZ:function(){var u,t=new P.T("")
t.a="\tMap<String, dynamic> toMap() {\n\t\treturn {\n"
